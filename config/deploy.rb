...
set :linked_dirs, %w(public/system public/uploads public/spree)
set :whenever_identifier, -> { "#{fetch(:application)}_#{fetch(:stage)}" }
set :delayed_job_workers, 1

set :delayed_job_prefix, :reports

set :delayed_job_queues, %w(mailer tracking)

set :delayed_job_pools,   mailer: 1,
                          tracking: 1,
                          :* => 1
...
after 'deploy:finishing', 'sitemap:gen_sitemap'
